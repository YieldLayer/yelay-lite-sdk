export const IYELAY_LITE_VAULT_ABI = [
	...
	},
	{
		inputs: [
			{
				internalType: 'address',
				name: '_yieldExtractor',
				type: 'address',
			},
		],
		name: 'setYieldExtractor',
		outputs: [],
		stateMutability: 'nonpayable',
		type: 'function',
	},
